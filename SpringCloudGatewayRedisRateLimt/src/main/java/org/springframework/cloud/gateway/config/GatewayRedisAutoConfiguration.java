...
class GatewayRedisAutoConfiguration {
    ...
    public RedisRateLimiter redisRateLimiter(ReactiveRedisTemplate<Object, Object> redisTemplate, ConfigurationService configurationService) {
        return new RedisRateLimiter(redisTemplate, configurationService);
    }
